...
//            printBTLog('Finished Scanning for Bluetooth Devices.');
            console.log(btDeviceSelect.val()+" stopped scanning");
...
//                            deviceOffset    = $("#btDeviceSelect")[0].selectedIndex;
                        ...
                        btDeviceName = deviceArray[deviceOffset].name;
                    console.log(deviceArray[deviceOffset]);
                        printBTLog('');
        ...
        $('.deviceitem')
                .click(function () {
                                chrome.bluetooth.getDevice(deviceArray[deviceOffset].address, function(deviceInfo) {
                                                printBTLog("");
